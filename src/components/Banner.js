            ...
            <div className="container">
              <div className="col s12 white-text center-align">
                ...
                <p className="left-align">
                  ...
                  Dolor voluptatem molestias quisquam illum quos quo laboriosam,
                  dolorum cupiditate rem, rerum itaque quas qui sunt eius
                  deleniti consectetur ullam fugit? Quidem.
                </p>
                <hr />
                <div className="row">
                  <a
                  ...
                  >
                    Twitter
                    <i className="fa fa-twitter right" aria-hidden="true"></i>
                  </a>
                  <a
                  ...
                  >
                    Github
                    <i className="fa fa-github right" aria-hidden="true"></i>
                  </a>
                </div>
              </div>
            </div>
